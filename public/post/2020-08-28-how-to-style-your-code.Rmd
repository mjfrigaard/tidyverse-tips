...
We are going to set the theme for our plots with [`hrbrthemes::theme_ipsum_tw()`](https://github.com/hrbrmstr/hrbrthemes).

```{r theme_set, eval=TRUE}
...
This shows more data points, but only one in 2019, so we will drop this year. I wonder how critic scores vary if we color them by `sales_type`?
...
TidyVidGam00_19 %>% 
  ...
  geom_point(aes(color=as.factor(sales_type)), 
             # lighten opacity
